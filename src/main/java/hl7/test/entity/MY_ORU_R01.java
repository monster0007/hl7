...
public class MY_ORU_R01 extends AbstractMessage {
    public MY_ORU_R01() {
        this(new DefaultModelClassFactory());
    }
    public MY_ORU_R01(ModelClassFactory factory) {
        super(factory);
        init(factory);
    ...
    public OBR getOBR(){return getTyped("OBR",OBR.class);}

    public OBX getOBX(){return getTyped("OBX",OBX.class);}
